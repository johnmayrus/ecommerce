<?php
    ...
    class Cart extends Model
    {
        ...
        private function resultadosMaiorQueZero(array $results =null)
        {
            if(empty($results)){
                return false;
            }
        ...
        public function getFromSessionId()
        {
            ...
            if ($this->resultadosMaiorQueZero($results)) {
                $this->setData($results[0]);
            }
        }
        ...
        public function setFreight($nrzipcode)
        {
            ...
            if ($totals['nrqtd'] > 0) {
                ...
                $qs = http_build_query([
                    ...
                    'nVlPeso' => $totals['vlweight'] < 1 ? 1 : $totals['vlweight'],
                    'nCdFormato' => '1',
...
//                exit();
        ...
        public function getProductsTotals()
        {
            ...
            $results = $sql->select("
                ...
                SUM(vlweight) AS vlweight, COUNT(*) AS nrqtd FROM tb_products a INNER JOIN tb_cartsproducts b
                ON a.idproduct = b.idproduct WHERE b.idcart = :idcart AND dtremoved IS NULL;",
                [
                    'idcart' => $this->getidcart()
                ]);
            return $results[0] ?? [];
