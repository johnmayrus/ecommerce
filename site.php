...
//        var_dump($cart->getValues());exit();
    ...
    $app->post("/register", function () {
        ...
        if (User::checkLoginExist($_POST['email']) === true) {
            User::setErrorRegister("email já cadastrado, tente outro email");
            header("location: /login");
            exit();
        }
        $user = new User();
    ...
    $app->post('/profile', function () {
        ...
        $user->setData($_POST);
        $user->upDate();
        User::setSuccess("Dados alteredos com sucesso!");
        header("location: /profile");
        exit();
    });
...
// INFORMACOES PARA O CLIENTE
        $dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja Flor de cacto story";
        $dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,00";
        $dadosboleto["demonstrativo3"] = "";
        $dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
        $dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
        $dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: suporte@hcode.com.br";
        $dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Loja Flor de cacto E-commerce - www.flordecacto.com.br";
...
// SEUS DADOS
        $dadosboleto["identificacao"] = "LOJA FLOR DE CACTO";
        $dadosboleto["cpf_cnpj"] = "24.700.731/0001-08";
        $dadosboleto["endereco"] = "Rua Ademar Saraiva Leão, 234 - Alvarenga, 09853-120";
        $dadosboleto["cidade_uf"] = "São Bernardo do Campo - SP";
        $dadosboleto["cedente"] = "FLOR DE CACTO LTDA - ME";
